...
function generateProfileCards(filteredCharacters = "") {
    ...
    for (const characterId in filteredCharacters) {
        ...
        nameParagraph.classList.add('boldText', 'center', 'm-sides');
        nameParagraph.textContent = character.name;

        const roleParagraph = document.createElement('p');
        roleParagraph.classList.add('boldText', 'wrap', 'p-05', 'c-type');
        roleParagraph.textContent = character.type;

        const teamsParagraph = document.createElement('p');
        teamsParagraph.classList.add('cardBD', 'cardDesc', 'm-sides', 'p-05');
        ...
        cardWrapper.classList.add('cards', 'flex', 'p-05');

        const gridWrapper = document.createElement('div');
        gridWrapper.classList.add('grid', 'grid-size');
        ...
        cardInfoWrapper.classList.add('cardInfo', 'p-05');
